...
const BUBBLES = [
  /* ── 発散・うごく ── */
  {t:"そとでジャンプしてみる",      g:"発散",    img:"act-jump-happy.png",    tags:{mood:["angry","happy"], energy:"high",    social:["alone","neutral"], body:["fine","heart"],  wish:"play"}},
  {t:"そのばではしってみる",        g:"発散",    img:"act-jump-happy.png",    tags:{mood:["angry","happy"], energy:"high",    social:["alone","neutral"], body:["fine","heart"],  wish:"play"}},
  {t:"かみをビリビリやぶいてみる",  g:"発散",    img:"act-tear-paper.png",    tags:{mood:"angry",           energy:["high","mid"], social:"alone",        body:["fine","heart"],  wish:["nothing","any"]}},
  {t:"まくらにさけんでみる",        g:"発散",    img:"act-scream-in-pillow.png",    tags:{mood:"angry",           energy:["high","mid"], social:"alone",        body:["fine","breath"], wish:["nothing","any"]}},
  {t:"ぎゅーっててをにぎってみる",g:"発散",     img:"act-jidanda.png",  tags:{mood:"angry",           energy:["high","mid"], social:["alone","neutral"], body:"heart",    wish:["nothing","play"]}},
  {t:"からだをぐるぐるうごかしてみる",g:"発散",  img:"act-jump-happy.png",  tags:{mood:["angry","happy"], energy:"high",    social:["alone","neutral"], body:"fine",       wish:"play"}},
  {t:"からだをのばしてみる",        g:"発散",    img:"act-stretch.png",    tags:{mood:["sad","anxious"],  energy:"low",     social:["alone","neutral"], body:"breath",     wish:["nothing","sleep"]}},
  {t:"おもいきりのびをしてみる",    g:"発散",    img:"act-stretch.png",    tags:{mood:["angry","anxious"],energy:["high","mid"], social:["alone","neutral"], body:"breath", wish:["nothing","play"]}},
  {t:"おもいっきりわらってみる",    g:"発散",    tags:{mood:"happy",           energy:"high",    social:["alone","social"],  body:"fine",       wish:"play"}},

  /* ── 落ち着く・ひとりで ── */
  {t:"トイレでゆっくりいきをはいてみる",g:"落ち着き",img:"act-deepbreath-in-bathroom.png",tags:{mood:"angry",        energy:["high","mid"],  social:"alone",        body:"breath",     wish:["nothing","play"]}},
  {t:"ゆっくりしんこきゅうしてみる",    g:"落ち着き",img:"act-deepbreath.png",tags:{mood:["anxious","angry"], energy:["low","mid"],   social:["alone","neutral"], body:"breath",  wish:["nothing","sleep"]}},
  {t:"しんこきゅうを3かいしてみる", g:"落ち着き",img:"act-deepbreath.png",tags:{mood:["anxious","angry"], energy:["low","mid"],   social:["alone","neutral"], body:"heart",   wish:["nothing","sleep"]}},
  {t:"4びょうすって8びょうはいてみる",g:"落ち着き",img:"act-deepbreath.png",tags:{mood:"anxious",        energy:["low","mid"],   social:["alone","neutral"], body:"heart",   wish:["nothing","sleep"]}},
  {t:"めをとじて10かぞえてみる",    g:"落ち着き",img:"act-closeeyes-char.png",tags:{mood:"anxious",          energy:["low","mid"],   social:"alone",        body:["heart","breath"], wish:"nothing"}},
  {t:"すわってめをとじてみる",      g:"落ち着き",img:"act-closeeyes-char.png",tags:{mood:["sad","anxious"],   energy:"low",     social:"alone",        body:["fine","bad"],wish:"nothing"}},
  ...
  {t:"めをとじてやすんでみる",      g:"落ち着き",img:"act-closeeyes-char.png",tags:{mood:["sad","anxious"],   energy:"verylow", social:"alone",        body:["fine","bad"],wish:"sleep"}},
  ...
  {t:"100までかぞえてみる",         g:"表現",    img:"act-stand-mad.png",    tags:{mood:"angry",            energy:["high","mid"],  social:["alone","neutral"],body:["fine","heart"],wish:["nothing","play"]}},
